            ...
            <div class="row justify-content-between align-items-center w-100">
                ...
                <div class="col-auto">
                    ...
                    <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                        ...
                        <div class="offcanvas-body">
                            <ul class="navbar-nav ms-auto align-items-lg-center gap-lg-4 pe-3">
                                ...
                                <li class="nav-item dropdown">
                                    ...
                                    <ul class="dropdown-menu border-0 shadow-sm rounded-3 p-3">
                                        {{-- <li><a class="dropdown-item py-2" href="#">Men</a></li>
                                      <li><a class="dropdown-item py-2" href="#">Women</a></li>
                                      <li><a class="dropdown-item py-2" href="#">Kids</a></li>
                                      <li>
                                          <hr class="dropdown-divider">
                                      </li>
                                      <li><a class="dropdown-item py-2" href="#">New Arrivals</a></li>
                                      <li><a class="dropdown-item py-2" href="#">Best Sellers</a></li>
                                      <li><a class="dropdown-item py-2 text-danger" href="#">Sale</a></li> --}}
                                        <li>
                                            <a class="dropdown-item py-2 {{ request()->is('products') ? 'active' : '' }}"
                                                href="{{ route('home') === url('/') ? url('/products') : route('home') }}">
                                                All Products
                                            </a>
                                        </li>
                                        ...
                                        @foreach ($navCategories as $category)
                                            <li>
                                                <a class="dropdown-item py-2 {{ request()->is('category/' . $category->slug) ? 'active' : '' }}"
                ...
                <div class="row">
                    <div class="col-md-6 d-flex flex-wrap">
                        <div class="shipping">
                            ...
                            <img src="{{ asset('frontend/images/arct-icon.png') }}" alt="icon">
                            <img src="{{ asset('frontend/images/dhl-logo.png') }}" alt="icon">
                        </div>
                        <div class="payment-option">
                            <span>Payment Option:</span>
                            <img src="{{ asset('frontend/images/visa-card.png') }}" alt="card">
                            <img src="{{ asset('frontend/images/paypal-card.png') }}" alt="card">
                            <img src="{{ asset('frontend/images/master-card.png') }}" alt="card">
                        </div>
                    </div>
